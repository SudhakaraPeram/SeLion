...
public final class ServletHelper {
    ...
    public static void displayMessageOnRedirect(PrintWriter writer, String reDirectMessage) throws IOException {
        String template = IOUtils.toString(LoginServlet.class.getResourceAsStream(MESSAGE_RESOURCE_PAGE_FILE), "UTF-8");
        writer.write(String.format(template, reDirectMessage));
     ...
     * @throws IOException
     */
    public static void loginToGrid(PrintWriter writer, String page, String messageToDisplay) throws IOException {
        String template = IOUtils.toString(LoginServlet.class.getResourceAsStream(page), "UTF-8");
        writer.write(String.format(template, messageToDisplay));
    }
}
