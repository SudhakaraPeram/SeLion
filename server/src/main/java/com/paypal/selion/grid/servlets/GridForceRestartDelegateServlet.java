...
public class GridForceRestartDelegateServlet extends RegistryBasedServlet {
    ...
    protected void process(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (request.getParameter("form_id") != null && request.getParameter("form_id").equals("restart_nodes")) {
            ...
            final String json = new GsonBuilder().serializeNulls().create().toJson(proxies);
            ...
            writer.write(String.format(template, jsonUtf8, GridForceRestartDelegateServlet.class.getSimpleName()));
        }
